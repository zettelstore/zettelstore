...
func (cs *configService) Initialize(logger *logger.Logger) {
	...
	cs.descr = descriptionMap{
		...
		config.KeyShowSubordinatesLinks: {"Show subordinate links", parseString, true},
		config.KeyShowSuccessorsLinks:   {"Show successor links", parseString, true},
	}
	cs.next = interfaceMap{
		...
		config.KeyShowSubordinatesLinks: "",
		config.KeyShowSuccessorsLinks:   "",
	}
}
